...
const Footer = () => {
  return (
    <footer className="bg-amber-950  pt-4 pb-8 xl:pt-8">
      <div className="w-10/12 px-4 mx-auto text-slate-50 sm:px-6 md:px-8 ">
        ...
        <li className="w-1/2 md:w-2/5 lg:w-2/5">
            <div className="text-left">
              ...
              <h2 className="text-slate-50 font-semibold text-md">
                PhotoInstamaxSemarang
              </h2>
              <p>Jl. Raya Gondang No. 25 Semarang</p>
            </div>
          </li>
        ...
        <div className="pt-8 flex border-t border-gray-200 max-w-xs mx-auto items-center justify-between">
          <a href="#">
            <svg
              ...
              height="20"
              fill="currentColor"
              className="text-xl transition-colors duration-200 hover:font-semibold"
