      ...
      <div className="flex w-full">
        ...
        <div className="border-l-2 border-white border-opacity-40 flex-1 mx-8">
          ...
          <div className="flex justify-end">
            <button className="my-8 px-8 py-1.5 hover:shadow-none shadow-[5px_5px_0px_0px_rgba(0,0,0,0.5)] bg-amber-100 text-lg font-semibold text-amber-950">Simpan</button>
          </div>
        </div>
      </div>
